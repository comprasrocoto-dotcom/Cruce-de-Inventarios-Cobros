...
export const StatsCard: React.FC<StatsCardProps> = ({ title, value, icon: Icon, color, description }) => {
        return (
                  <motion.div
                        ...
                        <div>
                                <p className="text-[11px] font-bold uppercase tracking-widest" style={{ color: '#8EA3BF' }}>
                                      {title}
                                </p>
                                <h3 className="text-2xl font-bold mt-1" style={{ color: '#FFFFFF' }}>
                                      {value}
                                </h3>
                              {description && (
                                            <p className="text-[10px] mt-1 font-medium" style={{ color: '#8EA3BF' }}>
                                                  {description}
                                            </p>
                                )}
                        </div>
